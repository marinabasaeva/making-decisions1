...
if (brittanisAge > amysAge) {
  ...
  console.log ("Brittani and Ami are same age")
}
...
// change the current value of changeMyMind to true(it should currently be set to false due to the if-else statement in Problem 9). 
